...
abstract class REST_Controller extends \CI_Controller {
     ...
     */
    public function get($key = NULL, $xss_clean = NULL, $dft = NULL)
    {
        if ($key === NULL)
        {
        ...
        return isset($this->_get_args[$key]) ? $this->_xss_clean($this->_get_args[$key], $xss_clean) : $dft;
    }
     ...
     */
    public function post($key = NULL, $xss_clean = NULL, $dft = NULL)
    {
        if ($key === NULL)
        {
        ...
        return isset($this->_post_args[$key]) ? $this->_xss_clean($this->_post_args[$key], $xss_clean) : $dft;
    }
